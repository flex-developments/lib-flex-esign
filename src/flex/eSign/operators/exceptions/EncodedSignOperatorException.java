...
/**
 * EncodedSignOperatorException
 * 
 * @author Ing. Felix D. Lopez M. - flex.developments en gmail
 * @version 1.0
 */
public class EncodedSignOperatorException extends Exception {
     ...
     */
    public EncodedSignOperatorException(String message) {
        super(message);
    }
    
    public EncodedSignOperatorException(Throwable ex) {
        super(ex);
    }
}
