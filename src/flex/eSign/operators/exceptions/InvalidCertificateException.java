...
public class InvalidCertificateException extends CertificateException {
    ...
    public InvalidCertificateException(String verificationMethod, Throwable ex) {
        super(ex);
        this.verifyMethod = verificationMethod;
    }
    ...
    public String getMessage() {
        return I18n.get(I18n.M_ERROR_CERITIFICATE_EXCEPTION_MESSAGE, verifyMethod);
    }
}
